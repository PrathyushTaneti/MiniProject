...
imgElon = face_recognition.load_image_file('ImagesBasic/Elon-musk.jpg') #source image
imgElon = cv2.cvtColor(imgElon,cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('ImagesBasic/elon.jpg') #testing image
